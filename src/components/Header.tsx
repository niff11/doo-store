...
export default function Header({
  ...
  const navLinks = [
    ...
    { label: categoryNames?.nitro || 'Nitro 1 month', view: 'nitro' },
    { label: categoryNames?.boosts || 'Boosts', view: 'boosts' },
    { label: categoryNames?.effects || 'Effects', view: 'effects' },
    { label: categoryNames?.users_premium || 'Premium Users', view: 'users_premium' },
    { label: categoryNames?.creations_custom || 'Custom Creations', view: 'creations_custom' },
    { label: categoryNames?.old_accounts || 'Old Accounts', view: 'old_accounts' },
